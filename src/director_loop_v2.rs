...
pub enum TimelineEvent {
    ...
    #[serde(rename = "Evaluate")]     Evaluate,
    #[serde(rename = "RegenRequest")] RegenRequest,
    #[serde(rename = "RegenApply")]   RegenApply,
    #[serde(rename = "Transition")]   Transition,
    #[serde(rename = "Finalize")]     Finalize,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub enum RunStatus {
    #[serde(rename = "PASSED")]      Passed,
    #[serde(rename = "REGENERATED")] Regenerated,
...
pub enum RegenTrigger {
    #[serde(rename = "StateViolation")]      StateViolation,
    #[serde(rename = "StructuralViolation")] StructuralViolation,
    #[serde(rename = "HashMismatch")]        HashMismatch,
    #[serde(rename = "ExternalOverride")]    ExternalOverride,
}
...
pub enum CorrectionRuleV2 {
    #[serde(rename = "RHYTHM_DRIFT")]    RhythmDrift,
    #[serde(rename = "MOTION_STRENGTH")] MotionStrength,
    #[serde(rename = "AV_ALIGNMENT")]    AvAlignment,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum CorrectionActionV2 {
    #[serde(rename = "adjust_xfade")] AdjustXfade,
    #[serde(rename = "regen_beat")]   RegenBeat,
}
